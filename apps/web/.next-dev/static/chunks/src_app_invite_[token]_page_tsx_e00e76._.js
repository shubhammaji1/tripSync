(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_invite_[token]_page_tsx_e00e76._.js", {
...
function AcceptInvitationPage({ params }) {
    ...
    const submit = async (event)=>{
        ...
        try {
            if (!user) {
                if (!isSignUpLoaded) throw new Error('Authentication is still loading. Please try again.');
...
_s(AcceptInvitationPage, "3GViMU0nhwMHL2dshyQL0ZhiiXI=", false, function() {
    return [
...
//# sourceMappingURL=src_app_invite_%5Btoken%5D_page_tsx_e00e76._.js.map